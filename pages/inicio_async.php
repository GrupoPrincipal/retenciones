            ...
            foreach($retenciones as $ret){
               ?>
                    <tr>
                        ...
                        <td><a class='fa fa-eye ifancybox' href="inicio_async.php?type=iva&prov=<?php echo $pro; ?>&id=<?php echo $ret['NUMLEGAL']; ?>" title="Retencion de iva">  </a></td>
                        <td><?php if($ret['ISLR']=='1'){ ?><a class='fa fa-eye ifancybox' href="inicio_async.php?type=islr&prov=<?php echo $pro; ?>&suc=<?php echo $dir; ?>&id=<?php echo $ret['NUMLEGAL']; ?>" title="Retencion de islr">  </a><?php } ?></td>
                    </tr>
                <?php
            }
            ?>
